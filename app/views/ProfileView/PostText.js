      ...
      <View style={{ marginLeft: 7, flex: 1 }}>
        <View style={styles.userInfo}>
          <View style={styles.row}>
            <Text style={[styles.name, { color: themes[theme].activeTintColor }]}>{item?.owner?.displayName}</Text>
        ...
        <View style={styles.userInfo}>
          <View style={styles.row}>
            <TouchableOpacity style={styles.row} onPress={() => onLike(isLiking)}>
              ...
              />
              <Text style={[styles.count, { color: themes[theme].activeTintColor }]}>{item.likes?.length ?? 0}</Text>
            </TouchableOpacity>
            <TouchableOpacity onPress={onPress} style={styles.row}>
              <Image source={images.chat} style={styles.chatIcon} />
              <Text style={[styles.count, { color: themes[theme].activeTintColor }]}>{item.comments?.length ?? 0}</Text>
            </TouchableOpacity>
          </View>
