    ...
    <TouchableOpacity
      ...
      <View
        style={[
          ...
          width ? { width } : {},
          height ? { height } : {},
          backgroundColor ? { backgroundColor: backgroundColor } : { backgroundColor: COLOR_BTN_BACKGROUND },
          {
            borderWidth: 0,
          },
        ]}>
        ...
        {loading ? (
          ...
          <>
            <Text style={[styles.text, { color: disabled ? themes[theme].subTextColor : textColor ? textColor : COLOR_WHITE, fontSize: fontSize ?? fontSize }]}>
              {text || title}
            </Text>
          </>
        )}
