...
export const VectorIcon = React.memo(({type, name, size, color, style, onPress}) => {
  switch (type) {
    case 'MaterialCommunityIcons':
      return <MaterialCommunityIcons name={name} size={size} color={color} style={style} onPress={onPress} />;
    case 'MaterialIcons':
    ...
    case 'EvilIcons':
      return <EvilIcons name={name} size={size} color={color} style={style} onPress={onPress} />;
    default:
      return <FontAwesome5 name={name} size={size} color={color} style={style} onPress={onPress} />;
  }
});
