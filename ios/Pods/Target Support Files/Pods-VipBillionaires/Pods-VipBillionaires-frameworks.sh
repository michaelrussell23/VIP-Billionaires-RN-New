...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/RNSoundPlayer/RNSoundPlayer.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-cameraroll/react_native_cameraroll.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-create-thumbnail/react_native_create_thumbnail.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-keyboard-controller/react_native_keyboard_controller.framework"
